...
(ns arvo.integraatio.organisaatiopalvelu
  (:require [arvo.arkisto.koulutustoimija :as koulutustoimija-arkisto]
            [arvo.arkisto.oppilaitos :as oppilaitos-arkisto]
            [arvo.arkisto.toimipiste :as toimipiste-arkisto]
            [arvo.arkisto.organisaatiopalvelu :as organisaatiopalvelu-arkisto]
